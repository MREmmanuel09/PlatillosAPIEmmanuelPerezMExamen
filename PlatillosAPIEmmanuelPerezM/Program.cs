...
using PlatillosAPIEmmanuelPerezM.Models;
...
internal class Program
{
    private static void Main(string[] args)
    {
       ...
       //builder.Services.AddDbContext<PlatillosAPIEmmanuelPerezM.PlatillosAPIEmmanuelPerezM>(options => options.UseSqlServer(CnnStr));
